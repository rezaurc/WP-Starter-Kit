...
function wp_starter_kit_post_meta() {
    if (get_post_type() == 'post') {
        echo sprintf(
                __('Posted %s in %s%s by %s. ', 'wp-starter-kit'), get_the_time(get_option('date_format')), get_the_category_list(', '), get_the_tag_list(__(', <b>Tags</b>: ', 'wp-starter-kit'), ', '), get_the_author_link()
        );
    }
